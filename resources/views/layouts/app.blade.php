...
<head>
    ...
    <title>{{ config('app.name') }}</title>
        ...
        <link rel="shortcut icon" href="{{asset('app-assets/img/favicon.png')}}">
        <link rel="apple-touch-icon" href="{{asset('app-assets/img/icon57.png')}}" sizes="57x57">
        <link rel="apple-touch-icon" href="{{asset('app-assets/img/icon72.png')}}" sizes="72x72">
        <link rel="apple-touch-icon" href="{{asset('app-assets/img/icon76.png')}}" sizes="76x76">
        <link rel="apple-touch-icon" href="{{asset('app-assets/img/icon114.png')}}" sizes="114x114">
        <link rel="apple-touch-icon" href="{{asset('app-assets/img/icon120.png')}}" sizes="120x120">
        <link rel="apple-touch-icon" href="{{asset('app-assets/img/icon144.png')}}" sizes="144x144">
        <link rel="apple-touch-icon" href="{{asset('app-assets/img/icon152.png')}}" sizes="152x152">
        <link rel="apple-touch-icon" href="{{asset('app-assets/img/icon180.png')}}" sizes="180x180">
        <!-- END Icons -->
        <!-- Fonts -->
        ...
        <link rel="stylesheet" href="{{asset('app-assets/css/themes.css')}}">
        <!-- END Stylesheets -->

        <!-- Modernizr (browser feature detection library) -->
        <script src="{{asset('app-assets/js/vendor/modernizr.min.js')}}"></script>
    </head>
    <body>
        <!-- Page Container -->
        ...
        <div id="page-container">
            ...
            <header>
                <div class="container">
                    <!-- Site Logo -->
                    <a class="site-logo" href="{{ url('/') }}"{{ config('app.name', 'site') }}>
        ...
        <script src="{{asset('app-assets/js/vendor/jquery.min.js')}}"></script>
